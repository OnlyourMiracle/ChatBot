...
corpus_post = '/home/aistudio/stc_weibo_train_post' #未处理的对话数据集
corpus_response = '/home/aistudio/stc_weibo_train_response' #未处理的对话数据集
...
save_path = '/home/aistudio/ChatBot/ChatBotV2/Chinese-Chatbot-PyTorch-Implementation/clean_chat_corpus/weibo.pth' #已处理的对话数据集保存路径

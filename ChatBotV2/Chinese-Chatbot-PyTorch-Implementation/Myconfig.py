...
class Config:
    ...
    Chatbot模型参数
    '''
    corpus_data_path = '/content/drive/MyDrive/raw_chat_corpus/weibo-400w/stc_weibo_train.pth' #已处理的对话数据
    use_QA_first = True #是否载入知识库
    max_input_length = 50 #输入的最大句子长度
    max_generate_length = 20 #生成的最大句子长度
    prefix = '/content/drive/MyDrive/Chinese-Chatbot-PyTorch-Implementation/checkpoints/chatbot'  #模型断点路径前缀
